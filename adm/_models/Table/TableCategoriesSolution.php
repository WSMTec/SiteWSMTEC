...
//PESQUISA
$Query = "SELECT * FROM tb_categories_solution";
...
foreach ($Read->getResult() as $dt):
    ...
    $SubData[] = ""
            . "<div>"
            . "<button name='btn-href[]' data-href='?exe=categories-solution/update&category={$category_id}' type='button' class='btn btn-primary btn-xs btn-left'><span class='lnr lnr-pencil'></span></button> "
            . "<button name='btn-modal[]' data-function='categories-solution-delete' value='{$category_id}' type='button' class='btn btn-danger btn-xs btn-rigth'><span class='lnr lnr-trash'></span></button>"
            . "</div>";
