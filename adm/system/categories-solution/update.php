...
<main class="content">
    ...
    <header class="header-box">
        <h2 class="header-box-h">Atualizar categoria de soluções</h2>
    ...
    <?php
    $Read->ExeRead("tb_categories_solution", "WHERE category_id = :id", "id={$office}");
    extract($Read->getResult()[0]);
    ?>
    <div class="box content-box">
        <form method="post" class="categories" id="form-categories-solution-update" action="categories-solution-update">
            <div class="row-f">
                <label>
                    ...
                    foreach ($Read->getResult() as $v):
                        ...
                        <div id="new-row" class="row-f new-row">
                            ...
                            <div style="margin-top: 1%;">
                                <div>
                                    <button name='btn-modal[]' data-function='categories-solution-delete' value='<?= $v['category_id']; ?>' type='button' class='btn-default btn-danger btn-table'><span class="lnr lnr-cross"></span> Remover</button>
                                </div>
                            </div>
                        </div>
                        <?php
