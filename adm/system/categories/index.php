<main class="content">
    <header class="header-box">
        <h2 class="header-box-h">Gerencie as categorias de artigos e notícias</h2>
        <div class="header-box-btn">
            <a class="btn-default btn-blue" href="?exe=categories/create"><span class="lnr lnr-plus-circle"></span> Nova categoria</a>
        </div>
    </header>
...
//                                    ($v['category_title'] ? $v['category_title'] : "<i style='color:#bbb;'>Não á uma subcategoria</i>");
                    ...
                    <div class="q_mob">
                        <div>
                            <button name='btn-href[]' data-href='?exe=categories/update&category=<?php $category_id ?>' type='button' class='btn btn-primary btn-xs btn-left'><span class='lnr lnr-pencil'></span></button> 
                            <button name='btn-modal[]' data-function='categories-delete' value='<?php $category_id ?>' type='button' class='btn btn-danger btn-xs btn-rigth'><span class='lnr lnr-trash'></span></button>
                        </div>
                    </div>
                </div>
                <?php
