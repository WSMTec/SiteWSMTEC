...
<main class="content">
    ...
    <header class="header-box">
        <h2 class="header-box-h">Cadastro de categorias de artigos e notícias</h2>
    ...
    <div class="box content-box">
        <form id="form-categories" method="post" class="form-categories" action="categories">
            <div class="row-m">
                <label>
            ...
            <div class="row-m">
                ...
                <select  class="inpt-null" name="category_parent">
                    ...
                    <?php
                    $Read = new Read;
                    $Read->ExeRead("ws_categories", "WHERE category_parent is null");
