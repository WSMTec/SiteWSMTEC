...
class Login {
    ...
    public function CheckLogin() {
        if (empty($_SESSION['userlogin']) || $_SESSION['userlogin']['nivel_user'] < $this->Level):
    ...
    private function setLogin() {
        ...
        elseif (!$this->getUser()):
            ...
            $this->Result = false;
        elseif ($this->Result['nivel_user'] < $this->Level):
    ...
    private function getUser() {
        ...
        $read = new Read;
        $read->ExeRead("tb_usuarios", "WHERE EmailUsuario = :e AND SenhaUsuario = :p", "e={$this->Email}&p={$this->Senha}");
